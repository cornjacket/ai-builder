...
check_file "$TARGET/project/tasks/scripts/new-user-task.sh"
check_file "$TARGET/project/tasks/scripts/new-user-subtask.sh"
check_file "$TARGET/project/tasks/scripts/new-pipeline-subtask.sh"
check_file "$TARGET/project/tasks/scripts/new-epic.sh"
check_file "$TARGET/project/tasks/scripts/new-project.sh"
check_file "$TARGET/project/tasks/scripts/list-projects.sh"
check_exec "$TARGET/project/tasks/scripts/new-user-task.sh"
check_exec "$TARGET/project/tasks/scripts/new-user-subtask.sh"
check_exec "$TARGET/project/tasks/scripts/new-pipeline-subtask.sh"
check_exec "$TARGET/project/tasks/scripts/new-epic.sh"
check_exec "$TARGET/project/tasks/scripts/new-project.sh"
check_exec "$TARGET/project/tasks/scripts/list-projects.sh"
...
check_file "$TARGET/project/tasks/scripts/user-task-template.md"
check_file "$TARGET/project/tasks/scripts/user-subtask-template.md"
check_file "$TARGET/project/tasks/scripts/pipeline-build-template.md"
...
check_contains "$TARGET/CLAUDE.md" "new-user-task.sh"      "CLAUDE.md contains scripts reference"
