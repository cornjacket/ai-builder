...
- **2026-04-30** — Created backlog task to add a post-push CI checker that polls gh run and surfaces failures, after main was left red for ~1.5h and only caught by the user. Task: `6d4102-post-push-ci-check`. Commit: `_pending_`.
