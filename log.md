...
- **2026-05-03** — Closed 64aa37-document-standard-task-workflow. Standard-task-workflow recipe is now in CLAUDE.md as the operator-facing playbook for parallel implementation across worktrees. Task: `64aa37-document-standard-task-workflow`. Commit: `dc2f590`.
