...
- **2026-05-02** — Added --category <branch> filter to list-tasks.sh: get_category and matches_category helpers, applied at depth-1 in print_status_tasks and print_dir_tasks. 'unclassified' matches Category '—' or missing. Task: `8ec43a-list-tasks-by-category`. Subtask: `8ec43a-0000-add-category-filter-flag`. Commit: `_pending_`.
