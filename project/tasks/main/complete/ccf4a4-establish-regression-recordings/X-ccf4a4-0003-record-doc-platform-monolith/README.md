# Task: record-doc-platform-monolith
...
Establish the first recording for the `doc-platform-monolith` regression and add replay
...
updated with a row for `doc-platform-monolith`. Use:

```bash
bash tests/regression/lib/add-to-recordings-readme.sh \
    --name        doc-platform-monolith \
