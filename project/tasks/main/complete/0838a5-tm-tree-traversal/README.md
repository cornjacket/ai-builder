...
<!-- subtask-list-start -->
- [x] [bc26d6-add-level-field-to-pipeline-subtask](bc26d6-add-level-field-to-pipeline-subtask/)
- [x] [93bd63-update-architect-for-level-aware-integrate](93bd63-update-architect-for-level-aware-integrate/)
- [x] [d1ca5e-implement-advance-pipeline-script](d1ca5e-implement-advance-pipeline-script/)
- [x] [1228fe-update-tm-prompt-for-tree-traversal](1228fe-update-tm-prompt-for-tree-traversal/)
- [x] [da887d-document-pipeline-behavior](da887d-document-pipeline-behavior/)
- [ ] [51315c-analyze-tm-prompt-for-ai-reduction](51315c-minimize-ai-in-tm-prompt/)
<!-- subtask-list-end -->
